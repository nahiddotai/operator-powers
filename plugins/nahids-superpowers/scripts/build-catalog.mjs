...
// catalog/superpowers.json and catalog/release.json. Never hand-edit the outputs.
...
const catalog = readFileSync(join(PLUGIN, "catalog", "superpowers.json"), "utf8");
...
writeFileSync(join(REPO, "site-data", "superpowers.json"), catalog);
console.log("build-catalog: regenerated mcp-service/src/{catalog,releases}.json and site-data/superpowers.json");
